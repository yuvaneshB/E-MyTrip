    ...
    <div style="margin-top: 10px; margin-bottom: 10px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
      ...
      <div style="margin: 32px 0; font-size: 14px; color: #334155; line-height: 1.6; border-top: 1px solid #cbd5e1; padding-top: 16px;">
        ...
        <p style="margin: 6px 0;">
          ...
          Download E-Ticket: <a href="${targetOrigin}/documents/${eticketToken}?type=eticket" style="color: #1e40af; text-decoration: underline; font-weight: 600;">Download E-Ticket</a><br/>
          <span style="color: #64748b; font-size: 11px;">${targetOrigin}/documents/${eticketToken}?type=eticket</span>
        </p>
        
        <p style="margin: 16px 0 0 0;">
          <strong>Itinerary:</strong><br/>
          Download Itinerary: <a href="${targetOrigin}/documents/${itineraryToken}?type=itinerary" style="color: #1e40af; text-decoration: underline; font-weight: 600;">Download Itinerary</a><br/>
          <span style="color: #64748b; font-size: 11px;">${targetOrigin}/documents/${itineraryToken}?type=itinerary</span>
        </p>
      </div>
