  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full chatbot-color-change-btn text-white flex items-center justify-center hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer ${
      ...
      {/* Floating chat panel */}
      <div className={`fixed bottom-24 right-6 w-[380px] max-w-[calc(100vw-32px)] h-[560px] max-h-[calc(100vh-120px)] bg-white border border-slate-200 rounded-3xl shadow-2xl z-50 flex flex-col overflow-hidden transform transition-all duration-300 origin-bottom-right font-sans ${
        isOpen 
